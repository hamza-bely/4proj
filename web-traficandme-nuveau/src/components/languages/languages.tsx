...
export default function Languages  ({ languages }: { languages : any} )  {
            ...
            <div className="relative">
                ...
                >
                    <span className="col-start-1 row-start-1 flex items-center gap-3 pr-6">
                        <img src={selectedLanguage.img} alt="Language flag" className="size-5 shrink-0" />
                        <span className="block truncate">{selectedLanguage.displayName}</span>
                    </span>
                    <svg
