            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={[styles.container, isDarkMode ? styles.darkContainer : styles.lightContainer]}>
                    ...
                    >
                        <View style={styles.inner}>
                            ...
                            <View style={styles.inputContainer}>
                                <Text style={[styles.label, isDarkMode ? styles.darkText : styles.lightText]}>Prénom</Text>
                                <TextInput
                                ...
                                />
                                <Text style={[styles.label, isDarkMode ? styles.darkText : styles.lightText]}>Nom</Text>
                                <TextInput
                                    style={[styles.input, isDarkMode ? styles.darkInput : styles.lightInput]}
                                    placeholder="Nom"
                                    autoCapitalize="words"
                                ...
                                />
                                <Text style={[styles.label, isDarkMode ? styles.darkText : styles.lightText]}>Confirmer le mot de passe</Text>
                                <TextInput
                                    style={[styles.input, isDarkMode ? styles.darkInput : styles.lightInput]}
                    ...
                    <View style={styles.footer}>
                        <TouchableOpacity style={styles.buttonLog} onPress={handleRegister}>
